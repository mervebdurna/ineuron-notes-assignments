...
tuple, dic, set, string
try to create a seprate class for each and everyting and
restructure
your
code
for all the segment and submit.
...
only
looking
for your seperate python file in your github link